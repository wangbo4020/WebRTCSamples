...
public class PeerConnectionClient {
	...
	public static class DataChannelParameters {
		...
		public DataChannelParameters(String label, boolean ordered, int maxRetransmitTimeMs,
		                             int maxRetransmits,
	...
	public static class PeerConnectionParameters {
		...
		public PeerConnectionParameters(boolean audioCallEnabled, boolean videoCallEnabled, boolean loopback,
		                                boolean tracing,
	...
	private void createPeerConnectionFactoryInternal(Context context) {
		...
		Log.d(TAG,
		      ...
		      ", Use audio: " + peerConnectionParameters.audioCallEnabled);
		isError = false;
...
//        PeerConnectionFactory.initializeFieldTrials(fieldTrials);
		...
		if (audioCallEnabled && peerConnectionParameters.audioCodec != null) {
			switch (peerConnectionParameters.audioCodec) {
			case AUDIO_CODEC_OPUS:
				preferredAudioCodec = AUDIO_CODEC_OPUS;
				break;
			case AUDIO_CODEC_ISAC:
				preferredAudioCodec = AUDIO_CODEC_ISAC;
				break;
			default:
				preferredAudioCodec = AUDIO_CODEC_OPUS;
				break;
		...
		WebRtcAudioRecord.setErrorCallback(new WebRtcAudioRecordErrorCallback() {
			...
			@Override
			public void onWebRtcAudioRecordStartError(AudioRecordStartErrorCode errorCode,
			                                          String errorMessage) {
		...
		WebRtcAudioTrack.setErrorCallback(new WebRtcAudioTrack.ErrorCallback() {
			...
			@Override
			public void onWebRtcAudioTrackStartError(WebRtcAudioTrack.AudioTrackStartErrorCode
	...
	private void createMediaConstraintsInternal() {
		...
		if (audioCallEnabled || peerConnectionParameters.loopback) {
		...
		if (peerConnectionParameters.aecDump) {
			try {
				aecDumpFileDescriptor =
						ParcelFileDescriptor.open(new File(Environment.getExternalStorageDirectory()
						                                              .getPath()
	...
	public void setRemoteDescription(final SessionDescription sdp) {
		executor.execute(() -> {
			...
			if (audioCallEnabled) {
				sdpDescription = preferCodec(sdpDescription, preferredAudioCodec, true);
			}
			if (videoCallEnabled) {
				sdpDescription = preferCodec(sdpDescription, preferredVideoCodec, false);
			}
			if (audioCallEnabled && peerConnectionParameters.audioStartBitrate > 0) {
	...
	private static String setStartBitrate(String codec, boolean isVideoCodec, String sdpDescription,
		...
		for (int i = 0; i < lines.length; i++) {
			...
			if (!sdpFormatUpdated && i == rtpmapLineIndex) {
				...
				if (isVideoCodec) {
					bitrateSet =
							"a=fmtp:" + codecRtpMap + " " + VIDEO_CODEC_PARAM_START_BITRATE + "=" +
							bitrateKbps;
				} else {
	...
	private static String joinString(
			                                Iterable<? extends CharSequence> s, String delimiter,
