...
public class HudFragment extends Fragment {
	...
	public final static String EXTRA_VIDEO_CALL = "extra_video_call";
	public final static String EXTRA_DISPLAY_HUD = "extra_display_hud";
